...
export const changeAnimationDelay = (context: Context) => {
...
export const changeGridDimension = (context: Context) => {
...
export const regenerateGridWithNewSize = (context: Context, drawGrid: () => void) => {
...
export const addEventHandlers = (context: Context) => {
    ...
    document.getElementById('delay')?.addEventListener("input", () => changeAnimationDelay(context));
    document.getElementById('dimension')?.addEventListener("input", () => changeGridDimension(context));
    document.getElementById('dimension')?.addEventListener("change", () => regenerateGridWithNewSize(context, drawGrid));
